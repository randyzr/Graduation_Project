...
// =============================================================================
// ELECROW DISPLAY HARDWARE ADAPTER
// =============================================================================
// LovyanGFX needs the exact timing and GPIO wiring of the 800x480 RGB panel.
// The rest of the project uses Elecrow7InchHMI without needing to know these
// low-level details. Treat this file as hardware configuration, not workflow.
