...
% Título de la tesis
\newcommand{\thesisTitle}{Diseño e implementación de un sistema inteligente de bajo costo para el control ESD en laboratorios de electrónica}
...
\setLectorI[F]{Ing. Marian Rojas Rojas}
\setLectorII{Por definir}
\setAsesor{M.Sc.-Ing.\, Javier Rivera Alvarado}
...
\begin{document}
  ...
  \include{body/Estado_Arte}
  \include{body/Meta_y_Objetivos}
  \include{body/Descripcion_Detallada_Solucion}
  \include{body/Presupuesto}
  \include{body/Metodologia}
  \include{body/Analisis_Resultados}
  \include{body/Conclusiones_Recomendaciones}
